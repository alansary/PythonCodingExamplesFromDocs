...
'''
 |  index_sub(...)
 |      L.index_sub(sub_list) -> integer -- return the first index of sub_list in L
 |	raise ValueError on faliure
'''
def index_sub(l, sub_list, start_index, end_index):
    if len(sub_list) == 1:
        try:
            l.index(sub_list[0])
            return l.index(sub_list[0])
        except:
        ...
        for element in sub_list:
            ...
            try:
                ...
                raise ValueError("sublist not found") # The sub_list doesn't exist in l
            ...
            for x in consecutive_list:
                for i in range(len(x)):
                    if sub_list[i] == l[x[i]]: # Looping through sub_list and l
                        ...
                        match = False
                        break
                if match == True: return x[0]
                print("match is", match)
            if match == False: raise ValueError("sublist not found")
l = [1, 2, 4, 5, 3, 4, 5, 6, 7, 8, 9, 4, 5, 6]
sub_list = [4, 5, 6]
print("The first index of the sub_list %r in the list %r is %d" % (sub_list, l, index_sub(l, sub_list, 0, len(l))))
sub_list = []
try:
    index_sub(l, sub_list, 0, len(l))
    print("The first index of the sub_list %r in the list %r is %d" % (sub_list, l, index_sub(l, sub_list, 0, len(l))))
except:
    print("The sub_list %r doesn't exist in the list %r" % (sub_list, l))
sub_list = [1, 2, 3]
try:
    index_sub(l, sub_list, 0, len(l))
    print("The first index of the sub_list %r in the list %r is %d" % (sub_list, l, index_sub(l, sub_list, 0, len(l))))
...
print("The first index of the sub_list %r in the list %r is %d" % (sub_list, l, index_sub(l, sub_list, 0, len(l))))
sub_list = [4, 5, 6]
print("The first index of the sub_list %r in the list %r, searching from index 5 to the end is %d" % (sub_list, l, index_sub(l, sub_list, 5, len(l))))
print("The first index of the sub_list %r in the list %r, searching from index 6 to the end is %d" % (sub_list, l, index_sub(l, sub_list, 6, len(l))))
print("The first index of the sub_list %r in the list %r, searching from index 5 to index 8, not including index 8 is %d" % (sub_list, l, index_sub(l, sub_list, 5, 8)))
